    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="container-lg">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-3 max-w-[70%]">
            <img src="/logo-wide.png" alt="PMII Kab Bandung - PC PMII Kabupaten Bandung" className="hidden sm:block h-12 lg:h-14 w-auto object-contain" />
            <img src="/logo-square.png" alt="PMII Kab Bandung" className="sm:hidden h-10 w-auto object-contain flex-shrink-0" />
            <span className="sm:hidden text-white font-bold text-sm tracking-tight leading-tight line-clamp-2">PMII<br/>Kab. Bandung</span>
          </Link>
