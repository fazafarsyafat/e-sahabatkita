...
const navItems: NavItem[] = [
  ...
  // ================= ADMIN & PENGURUS =================
  { href: '/dashboard/kader', label: 'Database Kader', icon: Users, roles: ['SUPER_ADMIN', 'ADMIN_CABANG', 'ADMIN_KOMISARIAT', 'ADMIN_RAYON'] },
  {
  ...
  // ================= USER / KADER BIASA =================
  {
    ...
    roles: ['ANGGOTA', 'ADMIN_KOMISARIAT', 'ADMIN_RAYON'] // Semua user bisa mengajukan
  },
  {
    href: '/dashboard/kaderisasi', label: 'Manajemen Kaderisasi', icon: BookOpen,
    roles: ['SUPER_ADMIN', 'ADMIN_CABANG', 'ADMIN_KOMISARIAT', 'ADMIN_RAYON'] // Hanya Admin yang bisa mengelola
  },
  {
    href: '/dashboard/kaderisasi-ku', label: 'Kaderisasi Saya', icon: BookOpen,
    roles: ['ANGGOTA', 'ADMIN_KOMISARIAT', 'ADMIN_RAYON'] // Dasbor internal untuk daftar & presensi
  },
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-center p-5 border-b border-gray-100 dark:border-gray-800 h-[76px]">
        {sidebarOpen ? (
          <img src="/logo-wide.png" alt="E-Sahabat" className="max-h-12 w-auto object-contain" />
        ) : (
          <img src="/logo-square.png" alt="E-Sahabat" className="w-9 h-9 object-contain" />
        )}
      </div>
