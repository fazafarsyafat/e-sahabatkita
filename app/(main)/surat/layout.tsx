...
export default function SuratLayout({
  ...
  return (
    <div className="pt-16">
      {/* Header Surat */}
      <section className="bg-gradient-to-br from-green-800 to-green-950 pt-16 pb-20 text-center relative overflow-hidden">
        <div className="absolute top-0 right-0 w-80 h-80 bg-white/5 rounded-full blur-3xl translate-x-1/3 -translate-y-1/3" />
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-green-400/10 rounded-full blur-3xl -translate-x-1/2 translate-y-1/2" />
        ...
        <div className="container-lg relative z-10">
          ...
          >
            <div className="inline-block px-4 py-1.5 bg-white/10 backdrop-blur-md rounded-full text-green-300 text-sm font-bold mb-6 tracking-widest uppercase shadow-xl">
              Layanan Administrasi
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6">
              Pusat <span className="text-green-300">Persuratan</span>
            </h1>
              ...
              return (
                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      layoutId="surat-tab"
                      className="absolute bottom-0 left-0 right-0 h-1 bg-green-600 dark:bg-green-500 rounded-t-full"
                      initial={false}
                    />
                  )}
                </Link>
