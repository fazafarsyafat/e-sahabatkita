  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden bg-white dark:bg-gray-950">
        ...
        <div className="absolute top-32 right-16 w-64 h-64 bg-primary-100 dark:bg-primary-900/20 rounded-full blur-3xl animate-pulse-slow" />
        <div className="absolute bottom-32 left-16 w-80 h-80 bg-gray-50 dark:bg-gray-900/50 rounded-full blur-3xl" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                <Link href="/login" className="btn-primary text-base px-6 py-3 shadow-lg shadow-primary-500/20">
                  <Lock size={18} /> Masuk Sistem
                </Link>
                <Link href="/register" className="btn-outline border-primary-200 dark:border-primary-800 text-primary-600 dark:text-primary-400 hover:bg-primary-500 hover:text-white hover:border-primary-500 text-base px-6 py-3">
                  <Users size={18} /> Daftar Anggota
                </Link>
                <Link href="#tentang" className="btn-ghost text-gray-600 dark:text-gray-400 text-base px-6 py-3">
                  Jelajahi <ArrowRight size={16} />
                </Link>
              </div>

              {/* Quick stats */}
              <div className="flex gap-6 mt-10 pt-8 border-t border-gray-100 dark:border-gray-800">
                {[
            ...
            >
              <div className="relative">
                {/* Main card */}
                <div className="bg-white dark:bg-gray-900 rounded-3xl p-6 shadow-2xl border border-gray-100 dark:border-gray-800 animate-float">
                  <div className="flex items-center justify-between mb-5">
                    <div>
                      <div className="text-gray-900 dark:text-white font-bold text-lg">Dashboard E-SAHABAT</div>
                      <div className="text-gray-500 dark:text-gray-400 text-sm">PC PMII Kab. Bandung</div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-5">
                    {[
                      { label: 'Total Kader', value: stats.totalKader, icon: Users, color: 'bg-green-50 dark:bg-green-900/20', textColor: 'text-green-500' },
                      { label: 'Komisariat', value: stats.totalKomisariat, icon: Globe, textColor: 'text-blue-500', color: 'bg-blue-50 dark:bg-blue-900/20' },
                      { label: 'Surat Keluar', value: stats.suratKeluar, icon: FileText, color: 'bg-purple-50 dark:bg-purple-900/20', textColor: 'text-purple-500' },
                      { label: 'Arsip', value: stats.arsipAktif, icon: Archive, color: 'bg-orange-50 dark:bg-orange-900/20', textColor: 'text-orange-500' },
                    ].map((item, i) => (
                      <motion.div
                        key={i}
                      ...
                      >
                        ...
                        <div className="text-gray-900 dark:text-white font-bold text-lg">{item.value}</div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="h-1.5 bg-gray-100 dark:bg-gray-800 rounded-full">
                        <motion.div className="h-full bg-primary-500 rounded-full" initial={{ width: 0 }} animate={{ width: '92%' }} transition={{ delay: 1, duration: 1 }} />
                      </div>
                    </div>
                    <div>
                      <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 mb-1">
                      ...
                      <div className="h-1.5 bg-gray-100 dark:bg-gray-800 rounded-full">
                        <motion.div className="h-full bg-green-500 rounded-full" initial={{ width: 0 }} animate={{ width: '87%' }} transition={{ delay: 1.2, duration: 1 }} />
                      </div>
                    </div>
                    <div>
                      <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 mb-1">
                      ...
                      <div className="h-1.5 bg-gray-100 dark:bg-gray-800 rounded-full">
                        <motion.div className="h-full bg-blue-500 rounded-full" initial={{ width: 0 }} animate={{ width: '78%' }} transition={{ delay: 1.4, duration: 1 }} />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <motion.div
                  ...
                  className="absolute -top-4 -right-4 bg-white dark:bg-gray-900 rounded-xl px-3 py-2 border border-gray-100 dark:border-gray-800 shadow-lg"
                >
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
                    <span className="text-gray-900 dark:text-white text-xs font-medium">Sistem Online</span>
                  </div>
                </motion.div>
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 1 }}
                  className="absolute -bottom-4 -left-4 bg-white dark:bg-gray-900 rounded-xl px-3 py-2 border border-gray-100 dark:border-gray-800 shadow-lg"
                >
                  <div className="flex items-center gap-2">
                    <Shield size={14} className="text-primary-500" />
                    <span className="text-gray-900 dark:text-white text-xs font-medium">Terenkripsi & Aman</span>
                  </div>
                </motion.div>
              </div>
            </motion.div>
      ...
      {/* STATISTIK */}
      <section className="section relative overflow-hidden bg-white dark:bg-gray-950">
        ...
        <div className="relative container-lg">
          ...
          >
            <h2 className="text-3xl font-black text-gray-900 dark:text-white mb-2">PC PMII Kabupaten Bandung dalam Angka</h2>
            <p className="text-gray-500 dark:text-gray-400">Data real-time organisasi kami</p>
          </motion.div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              >
                <div className="w-12 h-12 bg-primary-100 dark:bg-primary-900/30 rounded-2xl flex items-center justify-center mx-auto mb-3 text-primary-500">
                  <stat.icon size={22} />
                </div>
      ...
      {/* CTA SECTION */}
      <section className="section relative overflow-hidden bg-gray-50 dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800">
        <div className="absolute top-0 right-0 w-96 h-96 bg-primary-100 dark:bg-primary-900/20 rounded-full blur-3xl" />
        <div className="relative container-lg text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="w-16 h-16 bg-primary-100 dark:bg-primary-900/30 rounded-3xl flex items-center justify-center mx-auto mb-6">
              <Users size={32} className="text-primary-500" />
            </div>
            <h2 className="text-3xl lg:text-4xl font-black text-gray-900 dark:text-white mb-4">
              Bergabunglah dengan<br />
              <span className="text-primary-600 dark:text-primary-400">Keluarga Besar PMII</span>
            </h2>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="/register" className="btn-primary text-base px-8 py-3 shadow-xl">
                <Users size={18} /> Daftar Anggota Sekarang
              </Link>
              <Link href="/login" className="btn-outline text-base px-8 py-3 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white">
