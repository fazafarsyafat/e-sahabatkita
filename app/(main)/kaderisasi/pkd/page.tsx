  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="text-center mb-10">
        ...
        <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-2">Materi Induk Pelatihan Kader Dasar (PKD)</h2>
        <p className="text-gray-500 dark:text-gray-400">Modul tingkat menengah untuk kader mujahid PMII.</p>
      </div>
